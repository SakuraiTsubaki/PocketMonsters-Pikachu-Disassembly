...
Evidence-driven disassembly research for **Pocket Monsters Pikachu / Pokémon Yellow**.
...
| Scope | Japanese and localized Yellow releases across independently verified revisions. |
