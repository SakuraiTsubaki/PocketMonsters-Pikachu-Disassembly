...
IF DEF(_JAPAN)
	...
	text_box_text USE_TOSS_MENU_TEMPLATE,            14, 10, 19, 14, UseTossText,             16, 11
	...
	text_box_text BATTLE_MENU_TEMPLATE,               9, 12, 19, 17, BattleMenuText,          11, 14
...
ELIF DEF(_FRENCH)
	text_box_text JP_MOCHIMONO_MENU_TEMPLATE,         0,  0, 14, 17, TextBoxDummyText,         3,  0
	text_box_text USE_TOSS_MENU_TEMPLATE,            12, 10, 19, 14, UseTossText,             14, 11
	text_box_text JP_SAVE_MESSAGE_MENU_TEMPLATE,      0,  0,  7,  5, TextBoxDummyText,         2,  2
	text_box_text JP_SPEED_OPTIONS_MENU_TEMPLATE,     0,  6,  5, 10, TextBoxDummyText,         2,  7
	...
	text_box_text JP_AH_MENU_TEMPLATE,                7,  6, 11, 10, TextBoxDummyText,         8,  8
	text_box_text JP_POKEDEX_MENU_TEMPLATE,          11,  8, 19, 17, TextBoxDummyText,        12, 10
ELIF DEF(_GERMAN)
	text_box_text JP_MOCHIMONO_MENU_TEMPLATE,         0,  0, 14, 17, TextBoxDummyText,         3,  0
	...
	text_box_text JP_POKEDEX_MENU_TEMPLATE,          11,  8, 19, 17, TextBoxDummyText,        12, 10
ELIF DEF(_ITALIAN)
; Coordinates directly verified from the Italian reference ROM at Bank 01 $72BE.
	text_box_text JP_MOCHIMONO_MENU_TEMPLATE,         0,  0, 14, 17, TextBoxDummyText,         3,  0
	text_box_text USE_TOSS_MENU_TEMPLATE,            12, 10, 19, 14, UseTossText,             14, 11
	text_box_text JP_SAVE_MESSAGE_MENU_TEMPLATE,      0,  0,  7,  5, TextBoxDummyText,         2,  2
	text_box_text JP_SPEED_OPTIONS_MENU_TEMPLATE,     0,  6,  5, 10, TextBoxDummyText,         2,  7
	...
	text_box_text JP_POKEDEX_MENU_TEMPLATE,          11,  8, 19, 17, TextBoxDummyText,        12, 10
ELIF DEF(_SPANISH)
; Coordinates directly verified from the Spanish reference ROM at Bank 01 $72D4.
	text_box_text JP_MOCHIMONO_MENU_TEMPLATE,         0,  0, 14, 17, TextBoxDummyText,         3,  0
	text_box_text USE_TOSS_MENU_TEMPLATE,            12, 10, 19, 14, UseTossText,             14, 11
	text_box_text JP_SAVE_MESSAGE_MENU_TEMPLATE,      0,  0,  7,  5, TextBoxDummyText,         2,  2
	text_box_text JP_SPEED_OPTIONS_MENU_TEMPLATE,     0,  6,  5, 10, TextBoxDummyText,         2,  7
