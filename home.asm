...
; International CGB-capable builds place three high-frequency routines directly
; after the joypad vector. Japanese builds leave $0061-$0067 unused and keep the
; corresponding routines in the main Home section instead.
IF !DEF(_JAPAN)
